...
export default function Botaologin() {
    ...
    return (
        <div >                {/*Valor true da condição retorna o botaologado que dentro tem a função deslogar que apenas da signOut do firebase */}
            {usuariologado ? (<div className='botao_logado' onClick={mostrardeslogar}>
                ...
                /*Valor false da condição retorna o botao deslogado, botao deslogado pede para fazer login e com ele da para se registrar tambem */
